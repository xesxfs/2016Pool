package com.greensock
{
   ...
   public class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      public static function getAllTweensCount() : Number
      {
         var _loc4_:int = 0;
         var _loc2_:* = null;
      ...
      override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         var _loc9_:Number = this.cachedTotalTime;
         if(param1 >= _loc6_)
         {
            this.cachedTotalTime = _loc6_;
            this.cachedTime = this.cachedDuration;
            this.ratio = 1;
            _loc5_ = !this.cachedReversed;
         ...
         else if(param1 <= 0)
         {
            ...
            this.ratio = _loc15_;
            _loc15_ = _loc15_;
            this.cachedTime = _loc15_;
            this.cachedTotalTime = _loc15_;
            if(this.cachedReversed && _loc9_ != 0)
            {
               _loc5_ = true;
            }
         }
         ...
         if(_repeat != 0)
         {
            _loc14_ = this.cachedDuration + _repeatDelay;
            _loc7_ = _cyclesComplete;
            _cyclesComplete = this.cachedTotalTime / _loc14_ >> 0;
            if(this.cachedTotalTime / _loc14_ >> 0 == this.cachedTotalTime / _loc14_ && _cyclesComplete != 0)
            {
               _cyclesComplete = Number(_cyclesComplete) - 1;
            }
            _loc8_ = _loc7_ != _cyclesComplete;
            if(_loc5_)
            {
            ...
            {
               this.cachedTime = this.cachedTotalTime - _cyclesComplete * _loc14_;
         ...
         if(_loc13_ == this.cachedTime && !param3)
         {
            return;
         }
         if(!this.initted)
         ...
         if(_loc9_ == 0 && (this.cachedTotalTime != 0 || this.cachedDuration == 0) && !param2)
         {
         ...
         var _loc11_:PropTween = this.cachedPT1;
         while(_loc11_)
         {
            _loc11_.target[_loc11_.property] = _loc11_.start + this.ratio * _loc11_.change;
            _loc11_ = _loc11_.nextNode;
         }
